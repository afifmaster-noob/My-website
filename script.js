...
// Fungsi toggle yang betul-betul sync dengan status audio
...
      audio.pause();
    }
    // Icon akan ditukar oleh event listener di bawah
  } catch (err) {
    console.error("Gagal main audio:", err);
  }
}

// Sync ikon secara automatik bila audio main/pause
audio.addEventListener('play', () => {
  icon.src = 'sound-off.png'; // Tunjuk "bunyi sedang main"
});

audio.addEventListener('pause', () => {
  icon.src = 'sound-on.png'; // Tunjuk "bunyi sedang off"
});
